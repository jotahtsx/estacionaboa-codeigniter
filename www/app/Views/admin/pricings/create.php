            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <select name="pricing_category_id" id="pricing_category_id" class="form-select" required>
                        <option value="" disabled <?= old('pricing_category_id') === null || old('pricing_category_id') === '' ? 'selected' : '' ?>>
                            Selecione uma categoria
                        </option>
                        <?php foreach ($categories as $cat): ?>
                            <option value="<?= esc($cat['id']) ?>" <?= old('pricing_category_id') == $cat['id'] ? 'selected' : '' ?>>
                                <?= esc($cat['name']) ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
            ...
            <div class="col-md-2">
                <div class="mb-3">
                    ...
                    <input
                        ...
                        class="form-control money-mask"
                        value="<?= old('pricing_by_mensality') ?>"
                        required>
                </div>
            </div>
